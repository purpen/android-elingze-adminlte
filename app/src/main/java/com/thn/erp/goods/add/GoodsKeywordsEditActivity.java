...
public class GoodsKeywordsEditActivity extends BaseStyle2Activity implements ImpTopbarOnClickListener {
    ...
    private void initTopbar() {
        ...
        publicTopBar.setTopBarCenterTextView("商品关键字", getResources().getColor(R.color.THN_color_fontColor_primary));

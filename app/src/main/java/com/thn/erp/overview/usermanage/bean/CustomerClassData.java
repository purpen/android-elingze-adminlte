...
public class CustomerClassData implements Parcelable {
    ...
    protected CustomerClassData(Parcel in) {
        this.data = in.readParcelable(DataBean.class.getClassLoader());
        this.status = in.readParcelable(StatusBean.class.getClassLoader());
        this.success = in.readByte() != 0;
    }

    public static final Parcelable.Creator<CustomerClassData> CREATOR = new Parcelable.Creator<CustomerClassData>() {
        @Override
        public CustomerClassData createFromParcel(Parcel source) {
            return new CustomerClassData(source);
        }

        @Override
        public CustomerClassData[] newArray(int size) {
            return new CustomerClassData[size];
        }
    };
}

...
public class RepositoryManageFragmentRight extends BaseFragment {

    @BindView(R.id.recyclerView_repository_right)
    RecyclerView recyclerViewRepositoryRight;
    Unbinder unbinder;
    ...
    protected int getLayout() {
        return R.layout.fragment_repository_manage_fragment_right;
    }
    ...
    protected void initView() {
        recyclerViewRepositoryRight.setHasFixedSize(true);
        recyclerViewRepositoryRight.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
//        recyclerViewRepositoryRight.addItemDecoration(new ShopMarginDecoration(activity,R.dimen.dp5));
...
//                Toast.makeText(getActivity(), "postion:" + postion, Toast.LENGTH_SHORT).show();
        ...
        recyclerViewRepositoryRight.setAdapter(mRepositoryRecyclerViewAdapter);
    }

...
public class FreightData implements Parcelable {
    ...
    protected FreightData(Parcel in) {
        this.data = in.readParcelable(DataBean.class.getClassLoader());
        this.status = in.readParcelable(StatusBean.class.getClassLoader());
        this.success = in.readByte() != 0;
    }

    public static final Creator<FreightData> CREATOR = new Creator<FreightData>() {
        @Override
        public FreightData createFromParcel(Parcel source) {
            return new FreightData(source);
        }

        @Override
        public FreightData[] newArray(int size) {
            return new FreightData[size];
        }
    };
}
